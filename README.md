...
> 
> - All content is **READ-ONLY** and intended solely to showcase my skills and experience
> - **DO NOT** copy, distribute, or use any of these materials without explicit permission
> - Code samples are provided for reference only and should not be reproduced
> - All rights reserved © Hamza Jabari
...
Advanced machine learning projects focused on financial data analysis using Gold Futures dataset.

| Project | Description | Key Technologies |
|---------|-------------|-----------------|
| [Feature Engineering](Projects/Applied%20Analytical%20Modelling/Feature_engineer_Final.ipynb) | Technical indicator analysis (RSI, MACD) for gold price prediction | Scikit-learn, TA-Lib |
| [Explainable AI (XAI)](Projects/Applied%20Analytical%20Modelling/XAI_Final.ipynb) | Model interpretability using SHAP and LIME | SHAP, LIME |
| [Time Series Forecasting](Projects/Applied%20Analytical%20Modelling/Time_Series_Final.ipynb) | Gold price forecasting with seasonality analysis | Prophet, AutoTS |
| [Fuzzy Logic & Clustering](Projects/Applied%20Analytical%20Modelling/Fuzzy_Logic_Final.ipynb) | Fuzzy C-Means clustering with membership functions | Scikit-fuzzy |
| [GANs for Synthetic Data](Projects/Applied%20Analytical%20Modelling/GAN-final.ipynb) | Generative Adversarial Network for financial data | TensorFlow, Keras |
...
| Project | Description | Key Technologies |
|---------|-------------|-----------------|
| [Airbnb Data Science](Projects/Big%20Data/Airbnb_dataScience.ipynb) | End-to-end ETL pipeline with ML regression models | PySpark, REST APIs |
...
|-------------|---------------|
| [Introduction to Python](Certifications/DataCamp/Introduction%20to%20Python.pdf) | Python basics, data types, functions |
| [Intermediate Python](Certifications/DataCamp/Intermediate%20Python.pdf) | Matplotlib, dictionaries, pandas, control flow |
| [Introduction to NumPy](Certifications/DataCamp/Introduction%20to%20NumPy.pdf) | Array operations, broadcasting, vectorization |
| [Data Manipulation with pandas](Certifications/DataCamp/Data%20Manipulation%20with%20pandas.pdf) | DataFrames, merging, grouping, reshaping |
...
│   └── certificate.pdf
├── Experience/
│   └── AEPCO Apprenticeship Journey.pptx
├── Projects/
│   ├── Applied Analytical Modelling/
│   ├── Big Data/
│   ├── Bioinformatics/
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/hamzehJabari/Personal-Info.git
   ```
...
This repository and its contents are the intellectual property of Hamza Jabari. No part of this repository may be reproduced, distributed, or transmitted in any form without prior written permission.
